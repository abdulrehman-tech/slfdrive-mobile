...
plugins {
    ...
    // Reads android/app/google-services.json (committed; client config, not a
    // secret). Generated by `flutterfire configure` — the build hard-fails
    // without it.
    id("com.google.gms.google-services")
    // Version declared in android/settings.gradle.kts.
